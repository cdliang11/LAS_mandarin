...
parser.add_argument('--update', action='store_true',
                    help='')
parser.add_argument('--feat_online', type=strtobool, default=False, 
                    help='is or not for feat extraction in training')
    ...
    for line in lines:
        ...
        if args.feat:
            ...
            if utt_id in utt2num_frames.keys():
                xlen = int(float(utt2num_frames[utt_id]) * 100)
            else:
                raise ValueError(utt_id)
